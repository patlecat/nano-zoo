...
![Nano Zoo mascot](public/images/NanoZoo_Entrance_Header_small.jpg)

## Dokumentation und Information
Die Anforderungen fuer Teilnehmende am Hackathon findest du in [docs/User-Requirements.md](docs/User-Requirements.md).

Die Anleitung fuer Kinder zu den ersten Schritten mit Cursor findest du in [docs/erste-schritte-kinder-cursor.md](docs/erste-schritte-kinder-cursor.md).
